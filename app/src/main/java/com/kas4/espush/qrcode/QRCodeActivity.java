package com.kas4.espush.qrcode;
...
import com.kas4.espush.qrcode.camera.CameraManager;
...
//        startActivity(new Intent(QRCodeActivity.this, ResultActivity.class).putExtras(bundle));
    }
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        try {
            ...
            // RuntimeException.
            if (handler == null) {
                handler = new QRCodeActivityHandler(this, cameraManager, DecodeThread.ALL_MODE);
            }
